...
- `io.nop.biz.impl.BizObjectBuilder#buildBizObject`

  - `IObjMeta` -> `GraphQLObjectDefinition`:
    `io.nop.graphql.core.schema.meta.ObjMetaToGraphQLDefinition#toObjectDefinition`
    - `IObjPropMeta` -> `GraphQLFieldDefinition`:
      `io.nop.graphql.core.schema.meta.ObjMetaToGraphQLDefinition#toFieldDefinition`
  - `io.nop.biz.impl.BizObjectBuilder#buildOperations`
    - `io.nop.biz.impl.BizObjectBuilder#buildOperations`
      - `io.nop.biz.impl.BizObjectBuilder#buildActionOperation`
        - `io.nop.biz.impl.BizModelToGraphQLDefinition#toOperationDefinition`
      - `io.nop.biz.impl.BizObjectBuilder#buildServiceAction`

- `io.nop.biz.impl.BizObjectManager#getOperationDefinition`
  - `io.nop.biz.impl.BizObjectManager#getBizObject`
  - `io.nop.biz.api.IBizObject#getOperationDefinition`
