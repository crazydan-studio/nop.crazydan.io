...
详细说明见 [XMeta 属性的显示文本](#def_attr_props_prop_schema_graphql_labelProp)
...
## XMeta 属性的显示文本 {#def_attr_props_prop_schema_graphql_labelProp}
...
> - `graphql:labelProp` 的配置说明见 [XMeta 属性的显示文本](#def_attr_props_prop_schema_graphql_labelProp)；
> - 非必要情况，对关联目标对象的加载方式默认均为懒加载，即，`lazy="true"`；
