...
XMeta 的模型结构定义在
[/nop/schema/xmeta.xdef](https://gitee.com/canonical-entropy/nop-entropy/blob/master/nop-xdefs/src/main/resources/_vfs/nop/schema/xmeta.xdef)
中，用于定义业务对象的数据结构。
...
</TCol><TCol> 与数据字典关联的<b>当前对象</b>的属性名 </TCol>
<TCol> 否 </TCol><TDesc>
...
</TCol><TCol> 关联过滤查询所指向的<b>当前对象</b>的属性 </TCol>
<TCol> 否 </TCol><TDesc>
...
</TCol><TCol> <b>当前对象属性</b>的 Getter 函数 </TCol>
<TCol> 否 </TCol><TDesc>
...
</TCol><TCol> <b>当前对象属性</b>的 Setter 函数 </TCol>
<TCol> 否 </TCol><TDesc>
...
</TCol><TCol> 默认的 GraphQL 字段选择集合 </TCol>
<TCol> 否 </TCol><TDesc>
