...
class "ObjMeta" as obj_meta {
  props: List<ObjPropMeta>
}

class "ObjPropMeta" as obj_prop_meta {
}

class "OrmEntity" as orm_entity {
}
...
<TCol> xml-name </TCol><TCol> 权限控制名 </TCol>
<TCol> 是 </TCol><TDesc>
...
<TCol> multi-csv-set </TCol><TCol>  </TCol>
<TCol> 否 </TCol><TDesc>
