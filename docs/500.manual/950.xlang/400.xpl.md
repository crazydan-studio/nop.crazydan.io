...
- 仅在元模型（`*.xdef`）节点 [<xdef:post-parse/>](./xdef#tag_xdef_post_parse)
  的 Xpl 脚本中引用
...
- 可在元模型（`*.xdef`）节点 [<xdef:pre-parse/>](./xdef#tag_xdef_pre_parse)、
  [<xdef:post-parse/>](./xdef#tag_xdef_post_parse) 的 Xpl 脚本中引用
- 可在 DSL 节点 [<x:gen-extends/>](./xdsl#tag_x_gen_extends)、
  [<x:post-extends/>](./xdsl#tag_x_post_extends) 的 Xpl 脚本中引用
...
- 仅在 DSL 节点 [<x:gen-extends/>](./xdsl#tag_x_gen_extends)、
  [<x:post-extends/>](./xdsl#tag_x_post_extends) 的 Xpl 脚本中引用
